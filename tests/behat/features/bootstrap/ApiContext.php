...
//require_once __DIR__.'/../../../../vendor/phpunit/phpunit/Autoload.php';
...
class ApiContext implements Context
{
    ...
    public function __construct(array $parameters)
    {
        ...
        // set the default config for Guzzl (see: http://docs.guzzlephp.org/en/5.3/clients.html)
        $config = [
...
//        }
        ...
        assertSame(
            (int) $statusCode,
            (int) $this->getResponse()->getStatusCode(),
            $bodyOutput
        );
    }
